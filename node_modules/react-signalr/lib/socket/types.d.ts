...
export interface Context<T extends Hub> {
    ...
    invoke: <E extends keyof T["methods"], C extends Parameters<T["methods"][E]>>(methodName: E, ...args: C) => void;
    useSocketEffect: <E extends keyof T["callbacks"], C extends T["callbacks"][E]>(events: E, callback: C, deps: DependencyList) => void;
